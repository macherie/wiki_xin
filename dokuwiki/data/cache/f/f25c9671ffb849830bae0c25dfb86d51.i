a:24:{i:0;a:3:{i:0;s:14:"document_start";i:1;a:0:{}i:2;i:0;}i:1;a:3:{i:0;s:6:"header";i:1;a:3:{i:0;s:12:"1. 预充电";i:1;i:1;i:2;i:1;}i:2;i:1;}i:2;a:3:{i:0;s:12:"section_open";i:1;a:1:{i:0;i:1;}i:2;i:1;}i:3;a:3:{i:0;s:12:"preformatted";i:1;a:1:{i:0;s:286:" 在完成基本的初始化工作以后，系统需要检查供电系统，包括Battery及Battery Debug Board是否存在，Charger是否存在及Charger类型等，调用关系如下:
 sbl1_hw_init_secondary()->boot_pm_driver_init()->pm_driver_post_init()->pm_chg_sbl_charging_init()";}i:2;i:27;}i:4;a:3:{i:0;s:13:"section_close";i:1;a:0:{}i:2;i:319;}i:5;a:3:{i:0;s:6:"header";i:1;a:3:{i:0;s:16:"2. Charging Init";i:1;i:1;i:2;i:319;}i:2;i:319;}i:6;a:3:{i:0;s:12:"section_open";i:1;a:1:{i:0;i:1;}i:2;i:319;}i:7;a:3:{i:0;s:12:"preformatted";i:1;a:1:{i:0;s:184:" sbl_chg_app_ds =(uint16*)pm_target_information_get_module_lut_info(CHG_APP, NULL);
 获取充电算法的指定数据，sbl_chg_app_ds的取值为pm_config_target.c里面的chg_app_ds";}i:2;i:352;}i:8;a:3:{i:0;s:4:"code";i:1;a:3:{i:0;s:833:"
   uint16 chg_app_ds[] = {
...
";i:1;s:1:"c";i:2;N;}i:2;i:547;}i:9;a:3:{i:0;s:12:"preformatted";i:1;a:1:{i:0;s:460:" pm_smbb_chg_get_internal_charger_present()
 ...
 如果内部充电不存在，则会执行重启；
 ";}i:2;i:1390;}i:10;a:3:{i:0;s:13:"section_close";i:1;a:0:{}i:2;i:1872;}i:11;a:3:{i:0;s:6:"header";i:1;a:3:{i:0;s:36:"3.检测Battery和Debug  Board状态";i:1;i:1;i:2;i:1872;}i:2;i:1872;}i:12;a:3:{i:0;s:12:"section_open";i:1;a:1:{i:0;i:1;}i:2;i:1872;}i:13;a:3:{i:0;s:12:"preformatted";i:1;a:1:{i:0;s:84:" 1: 如果Debug Board存在，则执行启动流程（当然这里是不存在的）";}i:2;i:1922;}i:14;a:3:{i:0;s:4:"code";i:1;a:3:{i:0;s:103:"
   if( debug_board_present== TRUE) {
       next_state_ptr = &pm_chg_state__bootup_ok;  //Bootup OK
}
";i:1;s:1:"c";i:2;N;}i:2;i:2015;}i:15;a:3:{i:0;s:12:"preformatted";i:1;a:1:{i:0;s:259:" 2: 如果电池也不存在，则设置USB输出最大电流（500mA）注S700项目遇到电池没接ID脚，会识别电池不存在,会造成无论电池电压多少，都会开机，
 如果插入低功率的充电器的话，会造成重复的开关机.";}i:2;i:2128;}i:16;a:3:{i:0;s:4:"code";i:1;a:3:{i:0;s:248:"
...
";i:1;s:1:"c";i:2;N;}i:2;i:2398;}i:17;a:3:{i:0;s:12:"preformatted";i:1;a:1:{i:0;s:103:" 3: 如果电池存在，则检查是否低电，低电则进入充电模式，否则执行开机流程";}i:2;i:2656;}i:18;a:3:{i:0;s:4:"code";i:1;a:3:{i:0;s:757:"
...
";i:1;s:1:"c";i:2;N;}i:2;i:2768;}i:19;a:3:{i:0;s:12:"preformatted";i:1;a:1:{i:0;s:282:" 如果电池低电的话，接下来就是检查DCCharger或者USB Charger是否存在，如果存在则执行充电流程，不存在则关机，
 详细可以参考pm_chg_state__charger_type_detect；
 4: 预充电
 以USB充电为例，下面简单介绍下预充电的流程：";}i:2;i:3535;}i:20;a:3:{i:0;s:4:"code";i:1;a:3:{i:0;s:1209:"
...
";i:1;s:1:"c";i:2;N;}i:2;i:3832;}i:21;a:3:{i:0;s:12:"preformatted";i:1;a:1:{i:0;s:237:" 从上面的代码能看出，在充电循环里面先后检查了Battery和USB Charger是否存在，不存在则会退出循环，
 同时LED灯会有红色闪烁，最后检查低电，当电池电压大于3.5v时，系统启动；  ";}i:2;i:5051;}i:22;a:3:{i:0;s:13:"section_close";i:1;a:0:{}i:2;i:5051;}i:23;a:3:{i:0;s:12:"document_end";i:1;a:0:{}i:2;i:5051;}}